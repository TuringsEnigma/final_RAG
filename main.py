...
class Config:
    ...
    MAX_TOTAL_TOKENS = 1100       # Use 90% of Groq's 8192 limit
    MAX_CONTEXT_TOKENS = 775       # Plenty of context for insurance docs
    MAX_RESPONSE_TOKENS = 325       # Detailed answers need space
